  ...
  if (loading) {
    return (
      <div className="min-h-[60vh] flex items-center justify-center" style={{ backgroundColor: '#FAFAF9' }}>
        <div className="animate-spin rounded-sm h-12 w-12 border-b-2 border-[#1E3A5F]"></div>
      </div>
    )
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filtered.map(tool => (
            <a
              ...
              className="block bg-white rounded-sm border border-stone-100 p-5 hover:shadow-md hover:border-stone-300 transition-all group"
            >

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filtered.map(tool => (
            <a
              ...
              className="block bg-white rounded-xl border border-gray-100 p-5 hover:shadow-md hover:border-blue-200 transition-all group"
            >
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className={`px-2 py-0.5 text-xs rounded-full ${languageColors[tool.language] || 'bg-gray-100 text-gray-600'}`}>
                  {tool.language}
                </span>

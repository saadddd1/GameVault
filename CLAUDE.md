...
- 数据存储：`data/games.json`、`data/mods.json`、`data/tools.json`、`data/users.json`、`data/game-metadata.json`、`data/feedback.json`
...
| `/login` | `app/login/page.tsx` | **已删除** — 前台无需登录，管理员直接访问 `/login` |
